...
class InSpec extends ObjectBehavior
{
    ...
    {
        $dqlAlias = 'a';
        $expression = new Expr\Func('a.foo in', ':in_10');
        ...
        $queryBuilder->setParameter('in_10', $this->value)->shouldBeCalled()->willReturn($queryBuilder);
    ...
    {
        $dqlAlias = 'x';
        $expression = new Expr\Func('x.foo in', ':in_10');

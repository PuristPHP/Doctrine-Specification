...
class LeftJoinSpec extends ObjectBehavior
{
    ...
    {
        $queryBuilder->leftJoin('a.user', 'authUser', null, null, null)->shouldBeCalled()->willReturn($queryBuilder);
    ...
    public function it_uses_local_alias_if_global_was_not_set(QueryBuilder $queryBuilder): void
    {
        ...
        $queryBuilder->leftJoin('b.user', 'authUser', null, null, null)->shouldBeCalled()->willReturn($queryBuilder);
